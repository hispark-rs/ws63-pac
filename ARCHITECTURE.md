...
`ws63-pac` 是用 svd2rust 从 [`ws63-svd`](https://github.com/hispark-rs/ws63-svd) 生成的 WS63 寄存器访问层，
为 35 个片上外设提供 `RegisterBlock` 与 `Peripherals` 单例。

完整架构与评审（集中维护于主仓库）：
- 组件文档：<https://github.com/hispark-rs/ws63-rs/blob/main/docs/architecture/ws63-pac.md>
